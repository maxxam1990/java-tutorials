 ...
 * The purpose of this class file is to show how to use switch statements.
 * 
 * In this class file, we will use the java scanner utility to declare a scanner which will allow us to receive user's keyboard input. We will then prompt the user to enter a number from 
 * 1 to 12. When they enter their number, our program will use a switch statement to check the user's input and match the number entered with the corresponding month of the year. Finally
 * we will print out in a string the month that corresponds to the number the user entered.
 * 
 */
	...
	// Declare main method
	 public static void main(String[] args) {
		 ...
		 // Declare scanner variable, name is set to reader, but it could be different names as well.
	        ...
	        switch (month) {
	        	// Declare multiple cases to check condition. This is the format: case {checking condition} : this will happen. Make sure you break the statement when you finish.
	            ...
	            // Always remember to declare a default case. This case will happen when none of the previous conditions are met.
